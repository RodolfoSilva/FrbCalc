 ...
 * @returns {number}
 */
export const modAP3 = (ap1, ap2) =>
  Number(((50 - (ap1 + ap2) * 3) / 4).toFixed(1));
...
export const mediaFinal = (ap1, ap2, ap3) =>
  Number(Math.abs(((ap1 + ap2) * 3 + ap3 * 4) / 10).toFixed(1));
 ...
 * @returns {number}
 */
export const previsao = (ap3, apx) =>
  Number(((50 - (apx * 3 + ap3 * 4)) / 3).toFixed(1));
